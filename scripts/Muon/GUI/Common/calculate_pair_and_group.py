...
def calculate_difference_data(workspace_1, workspace_2):
    params = {}
    params["LHSWorkspace"] = workspace_1
    params["RHSWorkspace"] = workspace_2
    difference_data = algorithm_utils.run_Minus(params)
