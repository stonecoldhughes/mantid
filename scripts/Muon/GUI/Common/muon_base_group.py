...
class MuonBaseGroup(object):
    ...
    def get_asymmetry_workspace_names(self, runs):
        ...
        for run in runs:
            run_object = MuonRun(run)
            #print(self._asymmetry_estimate)
            #print("name is " + self._asymmetry_estimate[run_object].workspace_name)
            #print(self._asymmetry_estimate[run_object].is_hidden)
