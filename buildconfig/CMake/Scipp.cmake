...
execute_process(
	COMMAND ${CMAKE_COMMAND} -G${CMAKE_GENERATOR} -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/bin -DCMAKE_BUILD_TYPE=Release -DPYTHON_EXECUTABLE=${PYTHON_EXECUTABLE} "${CMAKE_BINARY_DIR}/scipp-src" -DCMAKE_INTERPROCEDURAL_OPTIMIZATION=OFF
  RESULT_VARIABLE result
