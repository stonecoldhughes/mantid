...
class LoadElementalAnalysisTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(detector1_ws.extractY()[1, 3318], 0.206791, delta=0.0001)
        ...
        self.assertAlmostEqual(detector2_ws.extractY()[2, 230], 243.729, delta=0.0001)
        ...
        self.assertAlmostEqual(detector3_ws.extractY()[0, 6029], 62.0691, delta=0.0001)
        ...
        self.assertAlmostEqual(detector4_ws.extractY()[2, 4083], 120.457, delta=0.0001)
...
class LoadPartialElementalAnalysisTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(detector1_ws.extractY()[2, 5237], 4.0, delta=0.0001)
        ...
        self.assertAlmostEqual(detector3_ws.extractY()[2, 4697], 10.0, delta=0.0001)
        # Check that the directory output is not empty
        self.assertIsNotNone(ws[1])
